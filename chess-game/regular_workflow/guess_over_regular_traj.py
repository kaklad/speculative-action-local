...
import yaml
import argparse
from utils import chat_completion_options, get_llm_client_and_model, normalize_provider, safe_model_name
...
def process_trajectory_with_guesses(
    ...
    output_filename = f"steps_info_{safe_model_name(config['guess']['model_name'])}_guess_{num_guesses}.json"
...
def main():
    ...
    if args.base_dir:
        ...
        for candidate in candidates:
            process_trajectory_with_guesses(candidate, config=config)
